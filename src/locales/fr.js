export default {
  ...
  share: {
    ...
    qr_info:
      "Vous pouvez également scanner ce QR Code avec la caméra d'un appareil mobile:",
    feedback:
      'Pour tout commentaire, écrivez à <a href="mailto:info@peer.school">info@peer.school</a>',
